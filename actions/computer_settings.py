...
# bilgisayar kontrol komutlarÄ± verdiÄŸinde bu dosya devreye girer.
#
...
def volume_set(value: int):
    ...
    if _OS == "Windows":
        try:
            ...
            print(f"[Settings] ðŸ”Š Volume â†’ {value}%")
            return
        except Exception as e:
            print(f"[Settings] âš ï¸ pycaw failed: {e}")
    elif _OS == "Darwin":
...
def _detect_action(description: str) -> dict:
    """
    Gemini ile kullanÄ±cÄ±nÄ±n ne yapmak istediÄŸini anlar.
    Herhangi bir dilde Ã§alÄ±ÅŸÄ±r.
    DÃ¶ner: {"action": str, "value": optional}
    """
...
Examples:
- "turn up the volume" â†’ {{"action": "volume_up", "value": null}}
- "set volume to 60" â†’ {{"action": "volume_set", "value": 60}}
- "sesi 80 yap" â†’ {{"action": "volume_set", "value": 80}}
- "close the app" â†’ {{"action": "close_app", "value": null}}
- "uygulamayÄ± kapat" â†’ {{"action": "close_app", "value": null}}
- "type hello world" â†’ {{"action": "type_text", "value": "hello world"}}
- "write good morning on screen" â†’ {{"action": "write_on_screen", "value": "good morning"}}
- "reload page 3 times" â†’ {{"action": "reload_n", "value": 3}}
- "tam ekran yap" â†’ {{"action": "full_screen", "value": null}}
- "sesi kÄ±s" â†’ {{"action": "volume_down", "value": null}}
- "sesi aÃ§" â†’ {{"action": "volume_up", "value": null}}
- "sustur" â†’ {{"action": "mute", "value": null}}
- "monte le son" â†’ {{"action": "volume_up", "value": null}}
- "ekranÄ± kapat" â†’ {{"action": "sleep_display", "value": null}}
- "monitÃ¶rÃ¼ kapat" â†’ {{"action": "sleep_display", "value": null}}
- "turn off screen" â†’ {{"action": "sleep_display", "value": null}}
...
- "lock the screen" â†’ {{"action": "lock_screen", "value": null}}
- "kÃ¼Ã§Ã¼lt" â†’ {{"action": "minimize", "value": null}}
- "minimize the window" â†’ {{"action": "minimize", "value": null}}
- "bÃ¼yÃ¼t" â†’ {{"action": "maximize", "value": null}}
- "parlaklÄ±ÄŸÄ± artÄ±r" â†’ {{"action": "brightness_up", "value": null}}
- "parlaklÄ±ÄŸÄ± azalt" â†’ {{"action": "brightness_down", "value": null}}
- "increase brightness" â†’ {{"action": "brightness_up", "value": null}}
- "wifi'yi aÃ§" â†’ {{"action": "toggle_wifi", "value": null}}
- "toggle wifi" â†’ {{"action": "toggle_wifi", "value": null}}
- "masaÃ¼stÃ¼nÃ¼ gÃ¶ster" â†’ {{"action": "show_desktop", "value": null}}
- "show desktop" â†’ {{"action": "show_desktop", "value": null}}
- "yeni sekme aÃ§" â†’ {{"action": "new_tab", "value": null}}
- "sekmeyi kapat" â†’ {{"action": "close_tab", "value": null}}
- "geri git" â†’ {{"action": "go_back", "value": null}}
- "ileri git" â†’ {{"action": "go_forward", "value": null}}
- "sayfayÄ± yenile" â†’ {{"action": "refresh_page", "value": null}}
- "yakÄ±nlaÅŸtÄ±r" â†’ {{"action": "zoom_in", "value": null}}
- "uzaklaÅŸtÄ±r" â†’ {{"action": "zoom_out", "value": null}}
- "kaydet" â†’ {{"action": "save", "value": null}}
- "geri al" â†’ {{"action": "undo", "value": null}}
- "screenshot al" â†’ {{"action": "screenshot", "value": null}}
- "ekran gÃ¶rÃ¼ntÃ¼sÃ¼ al" â†’ {{"action": "screenshot", "value": null}}
- "aÅŸaÄŸÄ± kaydÄ±r" â†’ {{"action": "scroll_down", "value": null}}
- "yukarÄ± kaydÄ±r" â†’ {{"action": "scroll_up", "value": null}}
- "karanlÄ±k mod" â†’ {{"action": "dark_mode", "value": null}}
...
- Return ONLY the JSON object, no explanation, no markdown."""
    ...
    try:
        ...
        print(f"[Settings] âš ï¸ Intent detection failed: {e}")
...
def computer_settings(
    ...
    """
    Bilgisayar ayarlarÄ± ve UI kontrolleri.

    parameters:
        action      : Ä°ÅŸlem adÄ± (verilmezse description'dan Gemini ile tespit edilir)
        description : KullanÄ±cÄ±nÄ±n doÄŸal dil komutu (herhangi bir dilde)
        value       : Ä°ÅŸleme Ã¶zgÃ¼ deÄŸer (ses seviyesi, yazÄ±lacak metin, tekrar sayÄ±sÄ± vb.)
    """
    if not _PYAUTOGUI:
    ...
    print(f"[Settings] âš™ï¸ Action: {action}  Value: {value}")
