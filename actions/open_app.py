# actions/open_app.py
# JARVIS â€” Cross-Platform App Launcher
...
def _launch_windows(app_name: str) -> bool:
    try:
        ...
        print(f"[open_app] âš ï¸ Windows launch failed: {e}")
        return False
...
def _launch_macos(app_name: str) -> bool:
    ...
    try:
        ...
        print(f"[open_app] âš ï¸ macOS Spotlight failed: {e}")
        return False
...
def open_app(
    ...
    print(f"[open_app] ðŸš€ Launching: {app_name} â†’ {normalized} ({system})")
